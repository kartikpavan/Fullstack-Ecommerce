...
const AdminSidebar = () => {
	...
	return (
		<div className="w-full">
			...
			<nav>
				<div className="text-md md:text-2xl p-4 hover:translate-x-4 hover:scale-105 duration-300">
					<NavLink to="/admin/home" className={activeLink}>
						Home
					</NavLink>
				</div>
				<div className="text-md md:text-2xl hover:translate-x-4 hover:scale-105 duration-300  p-4">
